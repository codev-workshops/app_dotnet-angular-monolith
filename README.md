...
A .NET 8 + Next.js 15 / React 19 monolith application demonstrating tightly coupled modules sharing a single database. This is the **"before"** state for monolith-to-microservices decomposition demos.
...
cd client-app && npm install && npm run build:prod && cd ..

# Run the API (serves React app too)
